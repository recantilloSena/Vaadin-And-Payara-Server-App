...
@NamedQueries({
    ...
    , @NamedQuery(name = "PurchaseOrder.findByIdCustomer", query = "SELECT p FROM PurchaseOrder p WHERE p.customerId.customerId = :IdCustomer ")        
...
public class PurchaseOrder implements Serializable {
    ...
    public String toString() {
        return "com.javaup.modelo.PurchaseOrder[ orderNum=" + orderNum + " ]";
    }
